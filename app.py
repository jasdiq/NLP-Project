# -*- coding: utf-8 -*-
"""
Created on Sat Sep 26 19:53:21 2020
...
path_models = "C:\\Users\\yasir Arafath\\model\\"
# RandomForest
path_rf = path_models + 'best_rfc.pickle'
with open(path_rf, 'rb') as data:
    rfc_model = pickle.load(data)

path_tfidf = "C:\\Users\\yasir Arafath\\Pikle_preprocess\\tfidf.pickle"
...
def get_reviews():
    ...
    # url definition
    url = "https://www.amazon.in/inches-Ready-UltraAndroid-32GA-Black/product-reviews/B07XMD275Q/ref=cm_cr_getr_d_paging_btm_next_4?ie=UTF8&reviewerType=all_reviews&pageNumber="
    ...
    # News identification
    Vu_tv = soup1.find_all('div', class_='a-section celwidget')
    len(Vu_tv)
    ...
    for n in np.arange(0, 358):

        # Getting the customer review
        review = Vu_tv[n].find('span', {"data-hook":"review-body"}).text
        cust_review.append(review)

        # Getting the date
        date_week = Vu_tv[n].find('span', {"data-hook":"review-date"}).text
        date.append(date_week)
